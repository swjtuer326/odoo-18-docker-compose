...
git clone --depth=1 git@github.com:swjtuer326/odoo-18-docker-compose.git $DESTINATION
...
echo "Odoo started at http://localhost:$PORT | Master Password: odoo | Live chat port: $CHAT"